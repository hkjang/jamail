...
export default function Navbar({ locale }: { locale: string }) {
    ...
    // If on login page, don't show navbar or show simplified one
                        ...
                        {isAuthenticated && (
                            <div className="ml-6 flex space-x-8">
                                <Link
                                    ...
                                    className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${pathname.includes('/dashboard')
                                ...
                                <Link
                                    ...
                                    className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${pathname.includes('/templates')
                                        ? 'border-blue-500 text-gray-900'
                                        : 'border-transparent text-gray-500 hover:border-blue-500 hover:text-gray-700'
                                        }`}
                                >
                                ...
                                <Link
                                    ...
                                    className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${pathname.includes('/settings')
                                        ? 'border-blue-500 text-gray-900'
                                        : 'border-transparent text-gray-500 hover:border-blue-500 hover:text-gray-700'
                                        }`}
                                >
